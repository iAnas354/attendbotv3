...
type CopyKey = Exclude<keyof typeof COPY.ar, "hoursTitle" | "weeklyTitle" | "alreadyCheckedIn" | "setupChannelDone" | "setupRolesDone" | "openSince" | "openCount" | "hours" | "manualAdjustmentAdded" | "manualAdjustmentRemoved">;
